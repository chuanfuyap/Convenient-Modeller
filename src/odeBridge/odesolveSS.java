...
public class odesolveSS {
    ...
    public odesolveSS(String sbmllink, String[] variables, int count, String[] names, String[] rID){
        link=sbmllink;
...
//        ByValue runn(String link,Pointer vals, int numVals, Pointer newparam, Pointer names,  int parametercount, Pointer rID, int time);
        ByValue runSolver2(String link,Pointer vals, int numVals, Pointer newparam, Pointer names,  int parametercount, Pointer rID);
//        void outputcleanup(Pointer pVals);
        void outputCleanup2(Pointer pVals);
    ...
    public double[] runsolver(double[] newparam) {
        ...
        ByValue values = runlib.runSolver2(link, variableNames, num, parameter, parameterIDs, parametercount, reactionIDs);
        ...
        runlib.outputCleanup2(values.vals);
        values.clear();
